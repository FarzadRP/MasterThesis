function [logAverageMissRate, fppi, missRate] = iEvaluateDetectionMissRateCombinedModels(...
...
%
% See also evaluateDetectionPrecision, evaluateDetectionAOS,
...
model3 = load('dayDetector1'); 
Detector = model3.dayDetectorNewTrain;
